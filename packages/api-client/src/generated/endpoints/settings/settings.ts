...
import type { Settings, UpdateSettings } from '../../model';
...
export const getPatchSettingsMutationOptions = <TError = unknown, TContext = unknown>(options?: {
...
export type PatchSettingsMutationBody = UpdateSettings;
export type PatchSettingsMutationError = unknown;

/**
 * @summary Update ordering settings
 */
export const usePatchSettings = <TError = unknown, TContext = unknown>(
  options?: {
    mutation?: UseMutationOptions<
      Awaited<ReturnType<typeof patchSettings>>,
      TError,
